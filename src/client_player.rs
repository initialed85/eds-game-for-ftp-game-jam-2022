...
pub fn spawn_player_at_client(
    player: Player,
    player_material_mesh: MaterialMesh2dBundle<ColorMaterial>,
    weapon: Weapon,
...
pub fn spawn_this_player_at_client(
    player_uuid: Uuid,
    color: Color,
    transform: Transform,
    ...
    spawn_player_at_client(
        player_and_weapon.0,
        get_player_material_mesh(meshes, materials, transform, color),
        player_and_weapon.1,
        commands,
    );
}

pub fn spawn_other_player_at_client(
    player_uuid: Uuid,
    color: Color,
    transform: Transform,
    meshes: &mut ResMut<Assets<Mesh>>,
