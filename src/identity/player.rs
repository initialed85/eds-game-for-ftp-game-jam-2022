...
use bevy::math::Vec3;
use bevy::prelude::{
    default, Color, ColorMaterial, Commands, Component, Entity, Mesh, Query, RegularPolygon, Res,
...
pub struct Player {
    ...
    pub unhandled_inputs: Vec<InputEvent>,
...
pub fn spawn_player(
    ...
    let mesh = meshes
        .add(Mesh::from(RegularPolygon::new(
