...
// weapon
pub const WEAPON_FIRE_RATE_SECONDS: f64 = 0.1;
pub const PROJECTILE_LINEAR_VELOCITY: f32 = 500.0;
pub const PROEJCTILE_DIMENSION_MULTIPLIER: f32 = 1.0 / 3.0;
pub const PROJECTILE_DENSITY: f32 = 10.0;
pub const PROJECTILE_EXPIRY_SECONDS: f64 = 5.0;
pub const PROJECTILE_NETWORK_UPDATE_RATE_SECONDS: f64 = 1.0 / 5.0;
pub const PROJECTILE_NETWORK_EMA_SMOOTHING_FACTOR: f64 = 0.85;
